...
import styles from './Immunohistochemistry.module.css'
...
const products = [
    {
        ...
        title: "Model: VitroStainer42",
        desc: "Máy nhuộm HMMD tự động (42 slide)",
        Hang: "Hãng SX: Vitro S.A"
    },
];
        ...
        <div className={styles.page}>
            ...
            <div className={styles.heroWrapper}>
                ...
                <div className={styles.heroTitle}>
                    <h1>Máy nhuộm HMMD tự động</h1>
                    <p>Trang chủ / Máy nhuộm HMMD tự động</p>
                </div>
            </div>
