...
import styles from './LaserSlide.module.css'
        ...
        <div className={styles.page}>
            ...
            <div className={styles.heroWrapper}>
                ...
                <div className={styles.heroTitle}>
                    <h1>Máy in mã vạch lam kính</h1>
                    <p>Trang chủ / Máy in mã vạch lam kính</p>
                </div>
            </div>
