...
import styles from './LaminatingMachine.module.css'
const products = [
    {
        image: "/assetsFull/maydancvr909.jpg",
        title: "Model: CVR909",
        desc: "Máy dán lamen tự động",
        Hang: "Hãng SX: Bio-optica"
    },
    {
        image: "/assetsFull/IPI Pathoslide.png",
        title: "Model: IPI Pathoslide",
        desc: "Máy dán lamen tự động",
        Hang: "Hãng SX: Island Polymer Industries GmbH"
    },
    {
        image: "/assetsFull/IPI Pathomat.avif",
        title: "Model: IPI Pathomat",
        desc: "Máy dán lamen tự động",
        Hang: "Hãng SX: Island Polymer Industries GmbH"
    },

];
const LaminatingMachine = () => {
    return (
        <div className={styles.page}>
            ...
            <div className={styles.heroWrapper}>
                ...
                <div className={styles.heroTitle}>
                    <h1>Máy dán lamen tự động</h1>
                    <p>Trang chủ / Máy dán lamen tự động</p>
                </div>
            </div>
...
export default LaminatingMachine