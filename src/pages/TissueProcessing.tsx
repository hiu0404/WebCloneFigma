...
import styles from './TissueProcessing.module.css'
import { FigmaImage } from '../components/FigmaImage';
import { Header } from '../components/Header/Header';
const products = [
    {
        image: "/assetsFull/BPRO450.jpg",
        title: "Model: B-PRO450",
        desc: "Máy xử lý tự động đứng kín dành cho mẫu mô học.",
        Hang: "Hãng SX: Bio-optica"
    },
      {
        image: "/assetsFull/quaytron.webp",
        title: "Model: PT072",
        desc: "Máy xử lý tự động quay tròn dành cho mẫu mô học.",
        Hang: "Hãng SX: Lupetec"
    },
];
        ...
        <div className={styles.page}>
            ...
            <div className={styles.heroWrapper}>
                ...
                <div className={styles.heroTitle}>
                    <h1>Máy xử lý mô tự động</h1>
                    <p>Trang chủ / Máy xử lý mô tự động</p>
                </div>
            </div>
...
export default TissueProcessing