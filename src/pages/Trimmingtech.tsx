...
import styles from './Trimmingtech.module.css'
const products = [
    {
        image: "/assetsFull/TrimmingTech130.jpg",
        title: "Model: TrimmingTech130",
        desc: "Bàn phẫu tích bệnh phẩm",
        Hang: " Hãng SX: Bio-optica"
    },
    {
        image: "/assetsFull/TrimmingTech150.jpg",
        title: "Model: TrimmingTech150",
        desc: "Bàn phẫu tích bệnh phẩm",
        Hang: " Hãng SX: Bio-optica"
    },
    {
        image: "/assetsFull/TrimmingTech180.jpg",
        title: "Model: TrimmingTech180",
        desc: "Bàn phẫu tích bệnh phẩm",
        Hang: "Hãng SX: Bio-optica"
    },
];
        ...
        <div className={styles.page}>
            ...
            <div className={styles.heroWrapper}>
                ...
                <div className={styles.heroTitle}>
                    <h1>Bàn phẫu tích bệnh phẩm</h1>
                    <p>Trang chủ / Bàn phẫu tích bệnh phẩm</p>
                </div>
            </div>
