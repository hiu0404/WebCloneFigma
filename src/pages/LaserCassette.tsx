...
import styles from './LaserCassette.module.css'
...
const products = [
    {
        ...
        title: "Model: UC600",
        desc: "Máy in mã vạch cassette",
        Hang: "Hãng SX: Citotest"
    },
      {
        image: "/assetsFull/UC160.webp",
        title: "Model: UC160",
        desc: "Máy in mã vạch cassette",
        Hang: "Hãng SX: Citotest"
    },
        ...
        <div className={styles.page}>
            ...
            <div className={styles.heroWrapper}>
                ...
                <div className={styles.heroTitle}>
                    <h1>Máy in mã vạch Cassette</h1>
                    <p>Trang chủ / Máy in mã vạch Cassette</p>
                </div>
            </div>
