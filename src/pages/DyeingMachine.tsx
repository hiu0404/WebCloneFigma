...
import styles from './DyeingMachine.module.css'
import { FigmaImage } from '../components/FigmaImage';
import { Header } from '../components/Header/Header';
const products = [
    {
        image: "/assetsFull/AUS240.jpg",
        title: "Model: AUS240",
        desc: "Máy nhuộm HE",
        ...
        <div className={styles.page}>
            ...
            <div className={styles.heroWrapper}>
                ...
                <div className={styles.heroTitle}>
                    <h1>Máy nhuộm thường quy</h1>
                    <p>Trang chủ / Máy nhuộm thường quy</p>
                </div>
            </div>
